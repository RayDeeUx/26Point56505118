...
class $modify(MyGJRotationControl, GJRotationControl) {
	...
	bool init() {
		...
		buttonSpriteCW->setTag(12102025);
		buttonSpriteCW->setID("26-point-56505118-clockwise"_spr);
		...
		buttonSpriteCCW->setTag(12102025);
		buttonSpriteCCW->setID("26-point-56505118-counterclockwise"_spr);
